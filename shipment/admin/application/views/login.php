                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block" >
                                <img src="<?php echo base_url('assets/img/images/Mobile login-pana.svg')?>" style="margin-top:70px;" alt="">
                            </div>
                            <div class="col-lg-6" style="margin-top:50px;">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="<?php echo site_url('Login/userLogin'); ?>">
                                        ...
                                        <input type="radio" name="type" value="Sales" required class="ml-3"> Sales
                                        <input type="radio" name="type" value="Shipment" required class="ml-3"> Shipment/Logistic
