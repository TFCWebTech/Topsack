  ...
  color: red;
     ...
     <div class="container-fluid" id="manage_staff">
                    ...
                    <div class="card-header py-3 d-flex">
                            ...
                            <h3 class="m-0 font-weight-bold text-primary">Manage Staff</h3>
                            <!-- <h6 class="m-0 font-weight-bold text-primary">Manage Staff</h6> -->
                            <button class="btn btn-primary float-right" data-toggle="modal" data-target="#myModal" id="addStaff">Add Staff</button>
                        </div>
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="<?php echo site_url('ManageStaff/addStaff')?>"  method="post">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <select class="form-control" id="sel1" name="role" required>
                                            ...
                                            <option value="Logistic/Shipment">Logistic/Shipment</option>
                                ...
                                <table class="table table-bordered" id="dataTable"  cellspacing="0">
                                    ...
                                    // echo '</pre>';
                                      //  echo $length;
                                        ...
                                        <tr>
                                        <td hidden> <?php echo $value['login_id']; ?></td>
                                            ...
                                            <button class="btn btn-primary float-center staffbtn" data-toggle="modal" data-target="#repassModal" onclick="rePassword('<?php echo $value['login_id']; ?>', '<?php echo $value['email']; ?>')">Re-Password</button></td>
                ...
                <div class="modal" id="editModal">
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <!-- Modal body -->
                                <div class="modal-body">
                                    <form action="<?php echo site_url('ManageStaff/editStaff')?>" method="post">
                                      <input type="text" id="update_staff_id" name="update_staff_id" hidden>
                                        <div class="form-group">
                                          <label for="Name">Name:</label>
                          ...
                          <div class="modal" id="repassModal">
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <!-- Modal body -->
                                <div class="modal-body">
                                    <form action="<?php echo site_url('ManageStaff/changePassword')?>" method="post" onsubmit="return validatePassword()">
                                    <input type="text" id="reset_login_id" name="reset_login_id" value="<?php echo $value['login_id']; ?>" hidden>
                                      <input type="text" id="resetPassMail" name="resetPassMail" value="<?php echo $value['email']; ?>" hidden>
                                        <div class="form-group">
            ...
            return false;
                          ...
                          <script>
                                function updateData() {
                                  ...
                                  var role = selectedRow.cells[4].innerText;
                                  var status = selectedRow.cells[5].innerText;
...
<script>
  function checkMail(){
   ...
   $.ajax({
    type: 'POST',
            url: "<?php echo site_url('ManageStaff/addStaffEmailCheck'); ?>",
            datatype: "html",
            data :{
...
<script>
  function checkEditMail(){
    ...
    loginID = $('#update_staff_id').val();
   $.ajax({
    type: 'POST',
            url: "<?php echo site_url('ManageStaff/editStaffEmailCheck'); ?>",
            datatype: "html",
            data :{
              searchEmail: searchEmail,
              loginID : loginID
