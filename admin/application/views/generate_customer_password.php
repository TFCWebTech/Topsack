                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block" >
                                <img src="<?php echo base_url('assets/img/images/genpassword.png')?>" style="margin-top:10px; width:100%;" alt="">
                            </div>
                            <div class="col-lg-6" style="margin-top:50px;">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="<?php echo site_url('Login/customerPasswordGenerate'); ?>" onSubmit="return checkPassword()">
                                      
                                        <div class="form-group mt-3">
                                        <input type="password" id="password1" name="password1" class="form-control input-shadow" placeholder="Enter New Password" required>
                                        </div>
                                        <div class="form-group">
                                        <input type="password" id="password2" name="password2" class="form-control input-shadow" placeholder="Enter Confirm New Password" required>
                                        </div>
   ...
   <!-- <div class="card card-authentication1 mx-auto my-5">
         <div class="card-body">
            <div class="card-content p-2">
               ...
               <form method="post" action="<?php echo site_url('Login/newPassword'); ?>" onSubmit="return checkPassword()">
                  <div class="form-group">
                  ...
                  <input type="text" id="token" name="token" value="<?php echo $token ?>" hidden>
                  <input type="text" id="login_id" name="login_id" value="<?php echo $login_id ?>" hidden>
