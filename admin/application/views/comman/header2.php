    ...
    <!-- <div class="topnav" id="myTopnav">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            if($this->session->userdata('type') == 'Admin') { ?>
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="<?php echo site_url('SampleChart') ?>"> 
                        <i class="fas fa-fw fa-tachometer-alt"></i>
                        <span>Sample Order</span></a>
                </li>
                <li class="nav-item ">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item " href="<?php echo site_url('PendingOrder')?>">Pending Order</a>
                            <a class="collapse-item" href="<?php echo site_url('TransitDetais')?>">Transit Order</a>
            ...
            <?php } elseif ($this->session->userdata('type') == 'Shipment') { ?>
                <li class="nav-item ">
                    <a class="nav-link" href="<?php echo site_url('TransitDetais') ?>"> 
                        <i class="fas fa-fw fa-tachometer-alt"></i>
                        <span>Transit Order</span></a>
                </li>
            <?php }
            ?>
